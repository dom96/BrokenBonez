...
public class SingleTouchHandler implements TouchHandler {
    ...
    public boolean onTouch(View v, MotionEvent event){
        synchronized (this){
            ...
            touchEvent.x = touchX = (int)(event.getX() * scaleX); //note
            touchEvent.y = touchY = (int)(event.getY() * scaleY); //note
            touchEventsBuffer.add(touchEvent);
            return true;
        }
    }
    //allow polling of the touch screen in relation to onTouch() method
